    ...
    public static void ValidateWifiPassword() {
        ...
        while (numberAttempts < 3) {
            ...
            if (!(wifiPassword.equals("ABC123"))) {
                System.out.println("Contraseña incorrecta intento número "
                        + numberAttempts);
                System.out.println("            Password:");
                wifiPassword = scannerInstance.nextLine();
            }else{
                ...
                while(numberAttempts2 < 4){
                    ...
                    if (value != 51){
                        System.out.println("Numero de la serie incorrecto, "
                                + "numero de intento = " +  numberAttempts2);
